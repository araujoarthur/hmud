function(c, a)
{
	...
	const subtext = "\n\n `AYou can access resources from:` `Dcommunist`.`Hmembers`"
	...
	function registerUser(){
			...
			#fs.chats.send({channel:"town", msg:"`AI just joined the` `DCommunist``H Party``A! Comrades, meet us at ``Dcommunist``A.``Hparty`"});
