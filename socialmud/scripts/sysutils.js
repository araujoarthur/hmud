function(context, args)
{
	...
	var pages = ["com", "feed", "credits", "blog", "documentation", "post", "profile", "search", "register", "login", "logout","friends","verify","global","error"];
	var restrictedPages = ["com","register","login","logout"];
	var restrictedUsernames = ["global","register", "admin", "moderator", "public", "private", "shared", "friends", "feed","verified","main","profile","none","error"];
	const ac = "account_"
	...
	function callPage(page, sargs){
		...
		if(pages.includes(page)){
			switch(page){
				...
				case "register": return #fs.socialmud.register(sargs);
				case "logout": return #fs.socialmud.logout(sargs);
				case "global": return #fs.socialmud.global(sargs);
				case "error": return #fs.socialmud.error(sargs);
			}
		}else{
